...
@section('breadcrumb')
@includeIf('layouts.breadcrumb', ['title' => 'Service', 'subtitle' => "Web And Application Development"])
@endsection
    ...
    <div class="container">
        ...
        <div class="service-details-content">
            ...
            <div class="service-details-info">
                ...
                <div class="single-info-box" style="float: right;"> 
                    <a class="default-btn" href="#">View Projects</a>
                </div>
            </div>
        </div>
    </div>
